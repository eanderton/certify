"""
Configuration parsing helpers borrowed from the Yum project (yum.config).
"""

__authors__ = ['Menno Smits']
__copyright__ = "Copyright 2002 Duke University"
...
class Option(object):
    '''
    This class handles a single configuration file option. Create
